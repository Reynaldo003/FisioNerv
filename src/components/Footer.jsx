                    ...
                    <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
                        <div className="flex items-start gap-4">
                            ...
                            <div className="text-sm text-slate-700 dark:text-neutral-200">
                                ...
                                <p className="mt-1 flex items-center gap-2 text-slate-600 dark:text-neutral-200">
                        ...
                        <div className="flex flex-col items-start gap-3 md:items-end">
                            <p className="text-xs font-medium uppercase tracking-[0.18em] text-slate-500 dark:text-neutral-200">
                                ¿Listo para agendar?
                            </p>
                            <a
