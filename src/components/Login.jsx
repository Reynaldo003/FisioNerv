    ...
    async function handleSubmit(e) {
        ...
        try {
            const resp = await fetch(`${API_BASE}/api/auth/token/`, {
                ...
                body: JSON.stringify({
                    username: email.trim(), // aquí puede ir email o username
                    password: pass,
                }),
            });
            ...
            <div className="w-full max-w-md">
                <div className="rounded-2xl bg-white shadow-xl border border-slate-200 px-6 py-7 sm:px-8">
                    <div className="mb-5 text-center">
                        <p className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-400">Fisionerv</p>
                        <h1 className="mt-1 text-xl font-semibold text-slate-900">Acceso administrativo</h1>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        <div className="space-y-1">
                            <label className="block text-xs font-medium text-slate-700">Usuario o correo</label>
