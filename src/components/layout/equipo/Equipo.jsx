...
import { UserPlus, Trash2, RotateCcw, Users, Shield, Mail, Phone, Image as ImgIcon, AlignLeft } from "lucide-react";
...
export function Equipo() {
    ...
    async function cargar() {
        ...
        try {
            ...
            const mapped = (Array.isArray(data) ? data : []).map((u) => ({
                ...u,
                rol: u.rol_out,
                telefono: u.telefono_out,
                descripcion: u.descripcion_out,
            }));
    ...
    const darAlta = async () => {
        ...
        try {
            ...
            if (!resp.ok) {
                ...
                alert(`No se pudo crear. HTTP ${resp.status}. Revisa consola.`);
                return;
            }
    ...
    const eliminar = async (id) => {
        const ok = confirm("¿Eliminar este usuario del equipo?");
        if (!ok) return;
    ...
    return (
        <div className="p-4">
            <div className="mx-auto ml-60 w-full max-w-6xl space-y-4">
                ...
                <div className="bg-white border border-slate-200 rounded-2xl shadow-sm">
                    ...
                    <div className="p-4 space-y-4">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                            ...
                            <div>
                                <label className="block text-[11px] font-semibold text-slate-600 mb-1">Usuario</label>
                                <input
                                    className="w-full rounded-md border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
                                    value={form.usuario}
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        className="w-full pl-9 rounded-md border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
                                        value={form.correo}
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <select
                                        className="w-full pl-9 rounded-md border border-slate-300 px-3 py-2 text-sm bg-white focus:outline-none focus:ring-2 focus:ring-violet-500"
                                        value={form.rol}
                            ...
                            <div className="md:col-span-2">
                                ...
                                <div className="relative">
                                    ...
                                    <textarea
                                        className="w-full pl-9 min-h-[42px] rounded-md border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
                            ...
                            <div>
                                <label className="block text-[11px] font-semibold text-slate-600 mb-1">Foto</label>
                                <div className="relative">
                                ...
                                {form.foto && (
                                    <p className="mt-1 text-[11px] text-slate-500">Archivo: {form.foto.name}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="flex flex-col sm:flex-row gap-2 sm:justify-end">
                            <button
                                type="button"
                                onClick={limpiar}
                                className="h-10 px-4 rounded-md border border-slate-300 text-slate-700 hover:bg-slate-50 flex items-center justify-center gap-2 text-sm"
                            >
                            ...
                            <button
                                ...
                                onClick={darAlta}
                                disabled={loading}
                                className="h-10 px-5 rounded-md bg-violet-600 text-white hover:bg-violet-700 disabled:opacity-60 flex items-center justify-center gap-2 text-sm font-medium"
                            >
                ...
                {/* Tabla usuarios */}
                <div className="bg-white border border-slate-200 rounded-2xl shadow-sm">
                    <div className="px-4 py-3 border-b border-slate-200 bg-slate-50 rounded-t-2xl flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                        <div>
                        ...
                        <input
                            className="w-full sm:w-72 rounded-md border border-slate-300 px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-violet-500"
                            value={query}
                    ...
                    <div className="p-4 overflow-x-auto">
                        <table className="min-w-full text-left border-separate border-spacing-y-1">
                            ...
                            <tbody>
                                {filteredUsers.map((u) => (
                                    <tr key={u.id} className="bg-slate-50/70 hover:bg-slate-100/80 rounded-md">
                                        ...
                                        <td className="px-3 py-2 text-right">
                                            <button
                                                ...
                                                className="inline-flex items-center gap-2 text-[11px] px-3 py-1.5 rounded-md border border-red-200 text-red-700 hover:bg-red-50"
                                            >
